...
function TreeView() {
  ...
  return (
    <div>
      ...
      <div className="p-2 pb-6 rounded-md outline-2 outline outline-gray-500 m-2 text-sm h-[80dvh]  overflow-auto max-h-[82dvh]  w-[99%] font-mono leading-normal  whitespace-pre break-normal [tab-size:2] treeView ">
